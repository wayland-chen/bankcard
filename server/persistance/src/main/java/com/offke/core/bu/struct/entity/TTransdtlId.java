 ...
 */
@Embeddable
public class TTransdtlId implements java.io.Serializable {
     ...
     * full constructor
     */
    public TTransdtlId(String accdate, Integer termid, Long termseqno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TTransdtlId))
            return false;
        TTransdtlId castOther = (TTransdtlId) other;

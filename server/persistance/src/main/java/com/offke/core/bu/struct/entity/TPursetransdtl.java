...
/**
 * TPursetransdtl entity.
 */
@Entity
@Table(name = "T_PURSETRANSDTL")
public class TPursetransdtl implements java.io.Serializable {

    // Fields    

    private TPursetransdtlId id;
     ...
     * default constructor
     */
    public TPursetransdtl() {
    }

    /**
     * minimal constructor
     */
    public TPursetransdtl(TPursetransdtlId id) {
        this.id = id;
    }
    ...
    public TPursetransdtlId getId() {
        return this.id;
    }

    public void setId(TPursetransdtlId id) {
        this.id = id;
    }

 ...
 */
@Embeddable
public class TRptaccbalId implements java.io.Serializable {
     ...
     * full constructor
     */
    public TRptaccbalId(String accdate, String accno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TRptaccbalId))
            return false;
        TRptaccbalId castOther = (TRptaccbalId) other;

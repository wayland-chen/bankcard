...
@Embeddable
public class TDoordevcardlistId implements java.io.Serializable {
     ...
     * default constructor
     */
    public TDoordevcardlistId() {
    }

    /**
     * full constructor
     */
    public TDoordevcardlistId(Integer deviceid, Integer custid, Integer weekid) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TDoordevcardlistId))
            return false;
        TDoordevcardlistId castOther = (TDoordevcardlistId) other;

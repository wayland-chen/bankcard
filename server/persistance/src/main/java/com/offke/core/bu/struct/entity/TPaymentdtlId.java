...
/**
 * TPaymentdtlId entity.
 */
@Embeddable
public class TPaymentdtlId implements java.io.Serializable {
     ...
     * default constructor
     */
    public TPaymentdtlId() {
    }

    /**
     * full constructor
     */
    public TPaymentdtlId(String accdate, Integer termid, Long termseqno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TPaymentdtlId))
            return false;
        TPaymentdtlId castOther = (TPaymentdtlId) other;

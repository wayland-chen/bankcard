...
/**
 * TPurseposdtlId entity.
 */
@Embeddable
public class TPurseposdtlId implements java.io.Serializable {
     ...
     * default constructor
     */
    public TPurseposdtlId() {
    }

    /**
     * full constructor
     */
    public TPurseposdtlId(String transdate, String devphyid, Integer devseqno, Integer cardno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TPurseposdtlId))
            return false;
        TPurseposdtlId castOther = (TPurseposdtlId) other;

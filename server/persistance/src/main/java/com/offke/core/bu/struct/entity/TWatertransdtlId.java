...
/**
 * TWatertransdtlId entity.
 */
@Embeddable
public class TWatertransdtlId implements java.io.Serializable {
     ...
     * default constructor
     */
    public TWatertransdtlId() {
    }

    /**
     * full constructor
     */
    public TWatertransdtlId(String accdate, Integer termid, Long termseqno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TWatertransdtlId))
            return false;
        TWatertransdtlId castOther = (TWatertransdtlId) other;

...
@Embeddable
public class TBusdtlId implements java.io.Serializable {
     ...
     * full constructor
     */
    public TBusdtlId(String transdate, String devphyid, Integer devseqno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TBusdtlId))
            return false;
        TBusdtlId castOther = (TBusdtlId) other;

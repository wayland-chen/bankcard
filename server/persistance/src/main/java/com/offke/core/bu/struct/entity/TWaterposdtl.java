 ...
 */
@Entity
@Table(name = "T_WATERPOSDTL")
public class TWaterposdtl implements java.io.Serializable {

    // Fields    

    private TWaterposdtlId id;
     ...
     * minimal constructor
     */
    public TWaterposdtl(TWaterposdtlId id, String status) {
        this.id = id;
        this.status = status;
    }
    ...
    public TWaterposdtlId getId() {
        return this.id;
    }

    public void setId(TWaterposdtlId id) {
        this.id = id;
    }

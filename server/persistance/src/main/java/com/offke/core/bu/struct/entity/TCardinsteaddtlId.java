...
@Embeddable
public class TCardinsteaddtlId implements java.io.Serializable {
     ...
     * default constructor
     */
    public TCardinsteaddtlId() {
    }

    /**
     * full constructor
     */
    public TCardinsteaddtlId(String accdate, Integer termid, Long termseqno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TCardinsteaddtlId))
            return false;
        TCardinsteaddtlId castOther = (TCardinsteaddtlId) other;

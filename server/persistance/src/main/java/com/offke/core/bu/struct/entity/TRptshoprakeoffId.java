...
/**
 * TRptshoprakeoffId entity.
 */
@Embeddable
public class TRptshoprakeoffId implements java.io.Serializable {
     ...
     * default constructor
     */
    public TRptshoprakeoffId() {
    }

    /**
     * full constructor
     */
    public TRptshoprakeoffId(String accdate, String accno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TRptshoprakeoffId))
            return false;
        TRptshoprakeoffId castOther = (TRptshoprakeoffId) other;

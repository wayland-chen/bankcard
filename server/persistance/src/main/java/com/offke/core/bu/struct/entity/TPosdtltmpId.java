 ...
 */
@Embeddable
public class TPosdtltmpId implements java.io.Serializable {
     ...
     * full constructor
     */
    public TPosdtltmpId(String transdate, String devphyid, Integer devseqno, Integer cardno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TPosdtltmpId))
            return false;
        TPosdtltmpId castOther = (TPosdtltmpId) other;

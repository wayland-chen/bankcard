 ...
 */
@Embeddable
public class TOperdtlId implements java.io.Serializable {
     ...
     * full constructor
     */
    public TOperdtlId(String accdate, Integer termid, Long termseqno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TOperdtlId))
            return false;
        TOperdtlId castOther = (TOperdtlId) other;

...
/**
 * TRptshopboardId entity.
 */
@Embeddable
public class TRptshopboardId implements java.io.Serializable {
     ...
     * default constructor
     */
    public TRptshopboardId() {
    }

    /**
     * full constructor
     */
    public TRptshopboardId(String accdate, String accno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TRptshopboardId))
            return false;
        TRptshopboardId castOther = (TRptshopboardId) other;

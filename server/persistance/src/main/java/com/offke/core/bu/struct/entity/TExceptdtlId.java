 ...
 */
@Embeddable
public class TExceptdtlId implements java.io.Serializable {
     ...
     * full constructor
     */
    public TExceptdtlId(String accdate, Integer termid, Long termseqno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TExceptdtlId))
            return false;
        TExceptdtlId castOther = (TExceptdtlId) other;

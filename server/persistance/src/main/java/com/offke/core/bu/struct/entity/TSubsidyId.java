 ...
 */
@Embeddable
public class TSubsidyId implements java.io.Serializable {
     ...
     * full constructor
     */
    public TSubsidyId(String batchno, Integer seqno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TSubsidyId))
            return false;
        TSubsidyId castOther = (TSubsidyId) other;

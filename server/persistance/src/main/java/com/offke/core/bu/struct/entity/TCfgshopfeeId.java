...
/**
 * TCfgshopfeeId entity.
 */
@Embeddable
public class TCfgshopfeeId implements java.io.Serializable {
     ...
     * default constructor
     */
    public TCfgshopfeeId() {
    }

    /**
     * full constructor
     */
    public TCfgshopfeeId(Integer shopid, Integer feetype) {
        this.shopid = shopid;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TCfgshopfeeId))
            return false;
        TCfgshopfeeId castOther = (TCfgshopfeeId) other;

 ...
 */
@Embeddable
public class TPosdtlId implements java.io.Serializable {
     ...
     * full constructor
     */
    public TPosdtlId(String transdate, String devphyid, Integer devseqno, Integer cardno) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TPosdtlId))
            return false;
        TPosdtlId castOther = (TPosdtlId) other;
